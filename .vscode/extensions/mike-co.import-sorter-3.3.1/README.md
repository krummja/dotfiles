...
![alt text](https://github.com/SoominHan/import-sorter/raw/master/./assets/import-sorter-example-1.gif "Import Sorter")

Deep directory sort:
![alt text](https://github.com/SoominHan/import-sorter/raw/master/./assets/import-sorter-example-2.gif "Import Sorter Directory")

Sort on before safe `(off by default)`:
![alt text](https://github.com/SoominHan/import-sorter/raw/master/./assets/import-sorter-example-3.gif "Sort on safe")

Prettier integration:
![alt text](https://github.com/SoominHan/import-sorter/raw/master/./assets/import-sorter-example-4.gif "Prettier integration")
