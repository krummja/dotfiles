...
class Utils {
    ...
    getConfiguration() {
        // {{{
        let workspaceConfiguration = vscode_1.workspace.getConfiguration("gruvboxMaterial");
        return {
    ...
    getThemeData(configuration) {
        ...
        return {
            dark: {
                ...
                semanticTokenColors: semantic_1.getSemantic(configuration, "dark"),
                colors: workbench_1.getWorkbench(configuration, "dark"),
                tokenColors: syntax_1.getSyntax(configuration, "dark"),
            },
            light: {
                ...
                semanticHighlighting: true,
                semanticTokenColors: semantic_1.getSemantic(configuration, "dark"),
                colors: workbench_1.getWorkbench(configuration, "light"),
                tokenColors: syntax_1.getSyntax(configuration, "light"),
            },
        };
    } // }}}
    isNewlyInstalled() {
