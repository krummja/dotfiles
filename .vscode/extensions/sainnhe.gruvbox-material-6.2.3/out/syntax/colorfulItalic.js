...
function getColorfulItalicSyntax(palette, italicComments) {
    let syntax = [
        // Syntax{{{
        {
            name: "String",
        ...
        {
            name: "Keyword Italic",
            scope: "keyword, modifier, variable.language.this, support.type.object, storage.type.function, storage.type.class",
            settings: {
                fontStyle: "italic",
            },
        },
        ...
        {
            name: "JSON grey",
            scope: "punctuation.support.type.property-name.end.json, punctuation.support.type.property-name.begin.json",
            settings: {
                foreground: palette.grey1,
            },
        },
...
exports.getColorfulItalicSyntax = getColorfulItalicSyntax;
//# sourceMappingURL=colorfulItalic.js.map