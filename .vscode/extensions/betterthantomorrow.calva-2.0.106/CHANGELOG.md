...
## [2.0.97] - 2020-05-02
- Fix: [The New Indent engine doesn't follow block rules in ns :require [#633](https://github.com/BetterThanTomorrow/calva/issues/633)](https://github.com/BetterThanTomorrow/calva/issues/633)
...
## [1.2.14] - 2018-04-06
- Change all keyboard shortcuts to use prefix `ctrl+alt+v`, due to old prefix not working on some alternate keyboard layouts. See [Issue [#9](https://github.com/BetterThanTomorrow/calva/issues/9)](https://github.com/PEZ/clojure4vscode/issues/9).
