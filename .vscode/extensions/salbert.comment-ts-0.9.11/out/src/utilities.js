...
function indexOfBlank(s, pos = 0) {
    return s.substr(pos).search(/\s/g);
}
exports.indexOfBlank = indexOfBlank;
/**
 ...
 */
function addToMap(tag, lineText, map) {
 ...
 * @returns map
 */
function createMap(editor, selection) {
 ...
 * @returns
 */
function separateCamelcaseString(str, separation = ' ') {
    str = trimUnderscores(str.trim());
    const regex = /[\s_]+|([a-z0-9])(?=[A-Z])/g;
    const result = str.replace(regex, '$1' + separation).toLowerCase();
    return result;
}
exports.separateCamelcaseString = separateCamelcaseString;
/**
 * Separates camelcase noun string
 * @param str
 * @returns
 */
function separateCamelcaseNounString(str) {
...
exports.separateCamelcaseNounString = separateCamelcaseNounString;
/**
 * Trims underscores
 * @param str
 * @returns
...
exports.trimUnderscores = trimUnderscores;
/**
 * Separates camelcase string
 * @param str
 * @param [cut]
 * @returns
 */
function separateCamelcase(str, cut = 0) {
...
exports.separateCamelcase = separateCamelcase;
/**
