...
(function (EType) {
    ...
    EType[EType["INTERFACE"] = 4] = "INTERFACE";
...
function generateAllGetterAndSetter(classesListGetter, classesListSetter) {
...
exports.generateAllGetterAndSetter = generateAllGetterAndSetter;
...
function createConstructor(thisClass) {
...
function createInterface(thisClass) {
    let items = thisClass.reads;
    let c = `\n\t/**`;
